...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet3 | P2P_LINK_TO_spine1_Ethernet4 | routed | - | 10.10.1.6/30 | default | 1550 | False | - | - |
| Ethernet4 | P2P_LINK_TO_spine2_Ethernet4 | routed | - | 10.10.2.6/30 | default | 1550 | False | - | - |
| Ethernet5 | P2P_LINK_TO_spine3_Ethernet4 | routed | - | 10.10.3.6/30 | default | 1550 | False | - | - |
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 172.16.0.72/32 |
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- | ---------------------- | ------- |
| 10.10.1.5 | None | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
| 10.10.2.5 | None | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
| 10.10.3.5 | None | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
...
router bgp 65101
   ...
   neighbor 10.10.1.5 remote-as None
   neighbor 10.10.1.5 local-as None no-prepend replace-as
   neighbor 10.10.1.5 description spine1
   neighbor 10.10.2.5 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.10.2.5 remote-as None
   neighbor 10.10.2.5 local-as None no-prepend replace-as
   neighbor 10.10.2.5 description spine2
   neighbor 10.10.3.5 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.10.3.5 remote-as None
   neighbor 10.10.3.5 local-as None no-prepend replace-as
